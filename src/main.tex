...
Another line of research examines the adaptive complexity of submodular maximization, that is the goal is to design approximation algorithms that are faster if parallelization is allowed. 
